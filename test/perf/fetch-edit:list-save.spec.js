    ...
    await t.test('has ran 50 times', async t => {
      await t.beforeEach(async () => {
        ...
        for (let i = 0; i < 50; i++) {
          ...
          chatroom.addUser({ id: 'u_new ', name: 'Jane' })
      ...
      await t.test('#fetch', async t => {
        await t.test('has ran 50 times', () => {
          ...
          assert.strictEqual(count, 50, `recorded count is: ${count}`)
        })
